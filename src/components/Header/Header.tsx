...
export default function Header() {
  ...
  // Nên các query này sẽ không bị inactive => Không bị gọi lại => không càn thiết phải set stale: Infinity
            ...
            <Popover
              RenderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart ? (
                    <div className='p-2'>
                      <div className='capitalize text-gray-100'>New products added</div>
                      <div className='mt-5'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        <div className='text-xs capitalize text-gray-400'>
                          {purchasesInCart.length > MAX_PURCHASES ? purchasesInCart.length - MAX_PURCHASES : ''} add to
                          cart
                        </div>
                        <Link
                          to={path.cart}
                    ...
                    <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                      ...
                      <div className='mt-3'>not have any product</div>
                    </div>
                  )}
                </div>
              }

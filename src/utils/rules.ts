...
export const getRules = (getValues?: UseFormGetValues<any>): Rules => ({
  ...
  confirm_password: {
    ...
    validate:
      typeof getValues === 'function' ? (value) => value === getValues('password') || 'Password khong khop' : undefined
  }
})
...
export const userSchema = yup.object({
  ...
  avatar: yup.string().max(1000, 'Độ dài url tối đa là 1000 ký tự'),

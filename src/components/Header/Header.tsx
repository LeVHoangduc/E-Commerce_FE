            ...
            <Popover
              RenderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    <div className='capitalize text-gray-400'>New products added</div>
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img src='' alt='pictur' className='h-11 w-11 object-cover' />
                        </div>
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>dasdasdasdasdadasdsadasdasdasdasdsadasds</div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>$49</span>
                        </div>
                      </div>
                    </div>
                    {/* ===== footer ===== */}
                    <div className='mt-6 flex items-center justify-between'>
                      <div className='text-xs capitalize text-gray-400'>add to cart</div>
